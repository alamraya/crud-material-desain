...
if(isset($_SESSION['id_admin'])==0){ 
    ...
    window.location.href="crud/login.php"</script>'; 
}else{ 
?>
          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            <li class="user-details cyan darken-2">
              <div class="row">
                <div class="col col s4 m4 l4">
                  <img src="images/avatar/<?php echo $avatar; ?>" alt="" class="circle responsive-img valign profile-image cyan">
                </div>
                <div class="col col s8 m8 l8">
                  <ul id="profile-dropdown-nav" class="dropdown-content">
                    ...
                    <li>
                      <a href="crud/logout.php" class="grey-text text-darken-1">
                        <i class="material-icons">keyboard_tab</i> Logout</a>
                    </li>
                  </ul>
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold">
                  <a href="?page=data_mahasiswa" class="waves-effect waves-cyan">
                ...
                <li>
                      <a href="crud/logout.php" class="waves-effect waves-cyan">
                        <i class="material-icons">keyboard_tab</i> Logout</a>
                    </li>
                <li>
